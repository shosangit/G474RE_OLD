...
#define WHO_AM_I_REG 0x75     //我是谁
#define PWR_MGMT_1_REG 0x6B   //电源管理1
#define SMPLRT_DIV_REG 0x19   //采样频率分频器
#define ACCEL_CONFIG_REG 0x1C //加速度计配置
#define ACCEL_XOUT_H_REG 0x3B //
#define TEMP_OUT_H_REG 0x41   //温度配置
