...
#ifndef AI_NETWORK2_H
#define AI_NETWORK2_H
#pragma once
...
#define AI_NETWORK2_IN_SIZE_BYTES { \
  AI_NETWORK2_IN_1_SIZE_BYTES, \
}
...
#define AI_NETWORK2_OUT_SIZE_BYTES { \
  AI_NETWORK2_OUT_1_SIZE_BYTES, \
}
 ...
 * @ref ai_network2_create. Both the activations memory buffer 
 ...
 * using @ref ai_network2_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK2_*
 * defines into file @ref network2.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
